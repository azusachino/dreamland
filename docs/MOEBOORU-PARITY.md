...
| Advanced query editor | [`QueryActivity.kt`](../vendor/moebooru/app/src/main/java/com/github/yueeng/moebooru/QueryActivity.kt:141), [`Model.kt`](../vendor/moebooru/app/src/main/java/com/github/yueeng/moebooru/Model.kt:621) | Free-form tags plus a Yande-serialized typed builder for rating, order, date, dimensions, score, ID, vote, megapixels, MD5, source, parent, pool, and user | **Partial:** aliases and editing an existing structured query remain; typed AST/serializers are required before multi-site reuse |
...
| Post detail metadata and actions | [`PreviewActivity.kt`](../vendor/moebooru/app/src/main/java/com/github/yueeng/moebooru/PreviewActivity.kt:222) | Image, tags, author/creator ID, source, checksum, parent/children state, rating, dimensions, download, favorite | **Partial:** similar search, author profile route, and other native actions |
