...
| Advanced query editor | [`QueryActivity.kt`](../vendor/moebooru/app/src/main/java/com/github/yueeng/moebooru/QueryActivity.kt:141), [`Model.kt`](../vendor/moebooru/app/src/main/java/com/github/yueeng/moebooru/Model.kt:621) | Free-form tags plus a typed desktop builder for rating, order, date, dimensions, score, ID, vote, megapixels, MD5, source, parent, pool, and user | **Partial:** aliases and editing an existing structured query remain |
