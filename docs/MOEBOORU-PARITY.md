...
| Pool browsing | `Model.kt` pool query fields and Moebooru pool API | Yande pool list/posts and ZIP queue; Konachan public pool list/posts | Dreamland extension; Yande ZIP auth/content-type acceptance and archive-history pagination remain release-gate work |
