...
| Typed tags and tag-driven search | [`PreviewActivity.kt`](../vendor/moebooru/app/src/main/java/com/github/yueeng/moebooru/PreviewActivity.kt:350) | Tags are shown and clickable in cards/detail; related tags can be explicitly loaded and searched | **Partial:** typed category styling and complete detail tag actions |
...
| Similar-image search | [`Model.kt`](../vendor/moebooru/app/src/main/java/com/github/yueeng/moebooru/Model.kt:316), `SimilarActivity.kt` | Konachan post detail opens the site-owned similar-search form; no in-app result view | **Partial:** browser-only form boundary; no verified JSON route or image handoff |
