...
These ADRs are the canonical record of why Dreamland is shaped as it is.
Accepted decisions should be amended only when the decision itself changes;
new alternatives or superseding choices get a new ADR.

| ADR | Title | Status |
| --- | --- | --- |
| [0001](0001-platform-and-toolchain.md) | Platform and toolchain | Accepted |
